          ...
          <nav className="hidden md:flex space-x-4 items-center">
            {[
              ...
              >
                <Link
                  to={item.path}
                  className={`px-4 py-2 rounded-md text-white font-medium hover:bg-teal-700 transition-colors duration-300 ${isActive(item.path)}`}
                >
                  {item.label}
                </Link>
              </motion.div>
            ...
            <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
              {[
                ...
                >
                  <Link
                    to={item.path}
                    className={`block px-3 py-2 rounded-md text-white font-medium hover:bg-teal-700 transition-colors duration-300 ${isActive(item.path)}`}
                  >
                    {item.label}
                  </Link>
                </motion.div>
